#' Puzzling out Pharmacometric Datasets
#'
#' Build a dataset for the NONMEM analysis from basic tabulated files
#'
...
puzzle = function(directory=NULL,
  ...
  ## import data
  # pk
  if (is.null(directory)) directory="" #NULL not compatible with file.path option
